...
# Aliases vistos en torneos CONMEBOL (variaciones comunes en odds API)
TEAM_ALIASES = {
    "Colo-Colo":              "Colo Colo",
    ...
    "U de Chile":             "Universidad de Chile",
    "Universidad de Chile (CHI)": "Universidad de Chile",
}


def fetch_standings():
    """Standings de la Primera División de Chile desde ESPN."""
    try:
        r = requests.get(
            'https://site.api.espn.com/apis/v2/sports/soccer/chi.1/standings',
...
def fetch_goals():
    ...
    for league_name in ['chile', 'chiprimera', 'chprimera']:
        try:
            ...
            continue
    logger.warning("Goals no disponibles en soccerstats para Chile — usando defaults")
    return {}


def main():
    logger.info("🔥 Liga: Primera División Chile (via ESPN)")
    ...
    with open('static/chile_stats.json', 'w', encoding='utf-8') as f:
        json.dump(combined_data, f, indent=2, ensure_ascii=False)
    print(f"\n✅ Archivo generado: static/chile_stats.json")
